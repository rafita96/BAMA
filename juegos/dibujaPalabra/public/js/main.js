...
class Ejercicio extends React.Component {
	...
	render() {
		if (this.state.pregunta >= this.total_preguntas) {
            ...
            var palabras;
            switch (this.props.nivel) {
                case 1: palabras = ['Pelota', 'Manzana', 'Corazón', 'Sol', 'Luna', 'Nube', 'Bota', 'Árbol', 'Ventana'];
                break;
                case 2: palabras = ['Flor', 'Pelota', 'Manzana', 'Corazón', 'Sol', 'Luna', 'Nube', 'Bota', 'Árbol', 'Ventana', 'Casa'];
                break;
                case 3: palabras = ['Flor', 'Pelota', 'Manzana', 'Corazón', 'Sol', 'Luna', 'Nube', 'Bota', 'Árbol', 'Ventana', 'Casa', 'Sombrilla', 'Automóvil', 'Piña', 'Palmera', 'Silla', 'Estrella', 'Ballena'];
                break;
            }

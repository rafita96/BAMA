					...
					<div className="row text-center">
						<div className="col-12">
							<audio id="player" controls>
								<source src={'/juegos/'+this.props.filename+'/data/songs/'+this.ejercicios[this.state.pregunta].pregunta+this.props.nivel+'.mp3'} type="audio/mpeg">
								</source>
					...
					<div className="row text-center">
						<div className="col">
						    <Opcion
						    	...
						    	{this.ejercicios[this.state.pregunta].opciones[0]}
						    	</Opcion>
						</div>
						...
						<div className="col">
						    <Opcion
						    	...
						    	seleccionado={this.state.seleccionado}
						    	seleccionar={this.seleccionar}>
						    	{this.ejercicios[this.state.pregunta].opciones[1]}
						    	</Opcion>
						</div>
						...
						<div className="col">
						    <Opcion
						    	...
						    	seleccionado={this.state.seleccionado}
						    	seleccionar={this.seleccionar}>
						    	{this.ejercicios[this.state.pregunta].opciones[2]}
						    	</Opcion>
						</div>
						...
						<div className="col">
						    <Opcion
						    	...
						    	seleccionado={this.state.seleccionado}
						    	seleccionar={this.seleccionar}>
						    	{this.ejercicios[this.state.pregunta].opciones[3]}
						    	</Opcion>
						</div>
					</div>
		...
		var config = {
			1 : [
		      ...
		      respuesta: "Tu camino y el mio",
					opciones : ["Gorrioncillo pecho amarillo", "Fallaste corazón", "La media vuelta"]
			},
				{
		      ...
		      respuesta: "Que te vaya bonito",
				...
				{
		      pregunta: "Gorrioncillo pecho amarillo",
		      respuesta: "Gorrioncillo pecho amarillo",
		      ...
		      respuesta: "Tequila con limón",
					opciones : ["Allá en el rancho grande", "Viva México", "Gorrioncillo pecho amarillo"]
			},
				{

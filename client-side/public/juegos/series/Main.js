				...
				<div>
					<div className="row text-center">
						<div className="col-12">
							<Img seleccionar={()=>{}} url={'/juegos/'+this.props.filename+'/data/img/'+this.ejercicios[this.state.pregunta].pregunta + ".png"} />
						</div>
					</div>
					...
					<div className="row text-center">
						<div className="col">
						    <Img
						    	url={'/juegos/'+this.props.filename+'/data/img/'+this.ejercicios[this.state.pregunta].opciones[0]+".png"}
						...
						<div className="col">
						    <Img
						    	url={'/juegos/'+this.props.filename+'/data/img/'+this.ejercicios[this.state.pregunta].opciones[1]+".png"}
						...
						<div className="col">
						    <Img
						    	url={'/juegos/'+this.props.filename+'/data/img/'+this.ejercicios[this.state.pregunta].opciones[2]+".png"}
						...
						<div className="col">
						    <Img
						    	url={'/juegos/'+this.props.filename+'/data/img/'+this.ejercicios[this.state.pregunta].opciones[3]+".png"}
